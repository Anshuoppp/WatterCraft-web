/**
* WatterCraft — Site Content & Configuration (V2.1 + Staff Application)
...
{ id: "apply", label: "Apply", icon: "star" },
{ id: "support", label: "Support", icon: "help" },
{ id: "discord", label: "Discord", icon: "discord", cta: true }
],
apply: {
/* Google Apps Script Web App URL — deploy ke baad yahan paste karo */
api: "",
discord: "https://discord.gg/fb3snfD9v7",
positions: ["Trial Helper", "Helper", "Senior Helper", "Moderator", "Senior Moderator", "Admin", "Senior Admin", "Manager", "Media"],
requirements: [
"Age 13+",
"Active Discord account with notifications enabled",
"Good knowledge of WatterCraft rules and gameplay",
"Clear communication in English or Hindi",
"No active punishment history (confirmed by the team)"
],
process: [
{ step: "Fill the form", text: "Complete every required field honestly." },
{ step: "Application ID", text: "You receive a WC-XXXXXX ID to track your status." },
{ step: "Review", text: "The team reviews applications in order. Please be patient." },
{ step: "Decision", text: "Accepted applicants are contacted on Discord for an interview." }
],
faq: [
{ q: "Can I apply for Owner or Admin directly?", a: "Founder / Owner / Co-Owner are not open for application. Start from Trial Helper or Helper and grow with the team." },
{ q: "How long does the review take?", a: "There is no fixed time. Applications are reviewed as the team has availability." },
{ q: "Can I apply more than once?", a: "One active application at a time. A new application is possible only after the previous one is closed." },
{ q: "Where do I check my status?", a: "Use the status checker on this page with your Application ID, or ask on Discord." }
]
},
features: [
...
{ icon: "person", title: "Staff Application", text: "Apply to join the team on the Apply page." }
]
},
footer: {
tagline: "BUILD. PROGRESS. CONQUER.",
